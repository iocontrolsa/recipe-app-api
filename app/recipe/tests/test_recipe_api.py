...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@example.com', password='testpass123', name='test user')
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='other_user@example.com', password='otheruserpass123')
        create_recipe(user=self.user)
    ...
    def test_update_user_returns_error(self):
        """Changing the user in a recipe returns error"""
    ...
    def test_create_recipe_with_new_tag(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'tags': [{'name': 'Oriental'}, {'name':'Dinner'}]
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        """ Create recipe with an existing tag. """
    ...
    def test_create_ingredient_on_update(self):
        """ Self test create an ingredient when updating a recipe """
        recipe = create_recipe(user=self.user)
